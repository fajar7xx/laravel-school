...
@section('content')
 ...
 <!--================Blog Area =================-->
 <section class="blog_area single-post-area pt-4">
    <div class="container">
       <div class="row">
          <div class="col-lg-8 posts-list">
             <div class="single-post">
                <div class="feature-img">
                   <img class="img-fluid" src="{{ asset('frontend') }}/img/blog/single_blog_1.png" alt="">
                </div>
                <div class="blog_details">
                   <h2>{{ $berita->judul }}</h2>
                   <ul class="blog-info-link mt-3 mb-4">
                      <li><a href="#"><i class="fa fa-user"></i> Travel, Lifestyle</a></li>
                      <li><a href="#"><i class="fa fa-calendar"></i> {{ $berita->created_at->format('D, d M Y') }}</a></li>
                   </ul>
                ...
                <div class="navigation-area">
                   <div class="row">
                      <div
                         ...
                         <div class="thumb">
                            <a href="#">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/post/preview.png" alt="">
                            </a>
                         </div>
                         <div class="arrow">
                            <a href="#">
                      ...
                      <div
                         ...
                         <div class="thumb">
                            <a href="#">
                               <img class="img-fluid" src="{{ asset('frontend') }}/img/post/next.png" alt="">
                            </a>
                         </div>
                      </div>
                   </div>
