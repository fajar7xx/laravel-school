        ...
        <div class="card-body">
          <div class="clearfix">
            ...
            <div class="float-right">
              ...
              <div class="fluid-container">
                <h3 class="font-weight-medium text-right mb-0">{{ totalGuru() }}</h3>
              </div>
            </div>
          </div>
          <p class="text-muted mt-3 mb-0">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="clearfix">
            ...
            <div class="float-right">
              <p class="mb-0 text-right">Jumlah Murid</p>
              <div class="fluid-container">
                <h3 class="font-weight-medium text-right mb-0">{{ totalSiswa() }}</h3>
              </div>
            </div>
          </div>
          <p class="text-muted mt-3 mb-0">
            <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Sampai Saat Ini </p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mb-0">Rangking 5 Teratas</h4>
                    {{-- <small href="#"><small>Show All</small></small> --}}
                </div>
                <p>Siswa/i Berprestasi dengan peringkat 5 teratas</p>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @php
                                $no = 1;
                            @endphp
                            @foreach (rangkingLimaBesar() as $item)
                            <tr>
                                <td>{{ $no++ }}</td>
